...
match x y
  ...
  -- Rule 4 - Mixed variable and constructor patterns
  = ⟦ match [x,y] [([[],bs],[])]
        ( match [x,y] [([as,[]],[])]
   ...
   -- 3× Rule 1 - Only variable patterns
   = case x of
       []     -> ⟦ match [] [([],[])] ⟧
                    ( match [x,y] [([as,[]],[])]
                      ( match [x,y] [([(a:as),(b:bs)],(a,b) : zip as bs)]
   ...
   -- Rule 3a and Rule 2. - Only constructor patterns
   = case x of
       []     -> []
       (z:zs) -> case y of
                   []     -> []
